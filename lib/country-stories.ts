  ...
  },
  {
    ...
    popCulture: {
      ...
      paragraphs: [
        ...
        "Rock and roll's foundations were laid by Black innovators in the early 1950s: Fats Domino's R&B hits, Chuck Berry's guitar-driven songwriting on 1955's \"Maybellene,\" and Little Richard's explosive vocal delivery on \"Tutti Frutti\" that same year set the template the genre still runs on. Elvis Presley, Buddy Holly, and Jerry Lee Lewis then carried that sound to a much wider mainstream audience later in the decade, Presley's July 5, 1954 Sun Studio recording of \"That's All Right\" is often cited as an early landmark of that crossover, not the genre's origin.",
